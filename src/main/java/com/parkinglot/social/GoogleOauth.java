...
public class GoogleOauth implements SocialOauth {
    ...
    private String GOOGLE_SNS_CLIENT_ID="888044228781-a8lit6br3kp14cp199ttc0ao0stqjiv1.apps.googleusercontent.com";
    @Value("${sns.google.callback.url}")
    private String GOOGLE_SNS_CALLBACK_URL="http://localhost:8080/auth/google/callback";
    @Value("${sns.google.client.secret}")
    private String GOOGLE_SNS_CLIENT_SECRET="FRjXgpk9zZwH-VXonTK4jPBe";
